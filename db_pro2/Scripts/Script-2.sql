/*
 * EMPLOEYEES 테이블의 구조를 복사한 새로운 테이블 2개를 만든다.
 * 		- EMP_COMMISION 테이블을 만든다. 이 테이블은 EMPLOYEE_ID, 
 * 		  FIRST_NAME, LAST_NAME, SALARY, COMMISSION_PCT 컬럼을 가진다.
 * 		- EMP_NO_COMMISSTION 테이블을 만든다. 이 테이블은 EMPLOYEE_ID, 
 * 		  FIRST_NAME, LAST_NAME, SALARY 컬럼을 가진다.
 */
...
SELECT * FROM EMP_COMMISSION;
/*
 * EMP_NO_COMMISSION 테이블에서 SALARY가 4000 이하인 사원들에 대해 SALARY 를 200 증가 시킨다.
 */
