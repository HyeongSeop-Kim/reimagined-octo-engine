...
SELECT SYSDATE AS Col1
 ...
 SELECT MONTHS_BETWEEN(SYSDATE, ADD_MONTHS(SYSDATE, 2)) AS Col1
  ...
  SELECT EXTRACT(YEAR FROM SYSDATE) AS Col1
       , EXTRACT(MONTH FROM SYSDATE) AS Co12
       , EXTRACT(DAY FROM SYSDATE) AS Co13
       , EXTRACT(HOUR FROM SYSTIMESTAMP) AS Co14
       , EXTRACT(DAY FROM SYSTIMESTAMP) AS Co15
       , EXTRACT(DAY FROM SYSTIMESTAMP) AS Co16
   FROM DUAL;
