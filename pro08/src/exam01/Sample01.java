...
public class Sample01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("s5.replace() - > " + s5);
		s5 = s5.replace("java", "자바");
		System.out.println("s5.replace() - > " + s5);
		
		String[] sArr;
		sArr = s5.split(" ");
		System.out.println("s5.split(\"Program\") -> " + Arrays.toString(sArr));
		...
		System.out.println("s5.substring(3,6) -> " + s5.substring(7,11));
		System.out.println("s5.substring(3,6) -> " + s5.substring(s5.indexOf("Meth"), s5.indexOf("Meth")+4));
