...
<body>
	...
	<hr>
	<h2>request.getParmeter(name)</h2>
	<p>
		request.getParmeter(name) -> <%=request.getParameter("param_name") %> 
		<br>
	...
	<hr>
	<h2>request.getParmeterValues()</h2>
	<p>
	...
	<hr>
	<h2>requst.setCharacterEncoding</h2>
	<p>	
